...
class Prisoner{
  constructor({prisoner_id, prison_id, prisoner_name, case_id, date_in, date_out, age, address, ward_id}){
  ...
  static async findOne(id){
    const result = await db.execute(`SELECT * FROM prisoner where prisoner_id = ?`, [id]);
    return result[0];
  }
